...
module Data.Text.ICU.ErrorCode
    (
     -- * Types
     ErrorCode,
     -- ** Low-level types
...
{-# INLINE isSuccess #-}
isSuccess = (<= #const U_ZERO_ERROR) . fromErrorCode

-- | Indicate whether the given error code is a failure.
isFailure :: ErrorCode -> Bool
{-# INLINE isFailure #-}
isFailure = (> #const U_ZERO_ERROR) . fromErrorCode

#{enum ErrorCode, ErrorCode,
  u_USING_FALLBACK_WARNING = U_USING_FALLBACK_WARNING,
  u_ERROR_WARNING_START = U_ERROR_WARNING_START,
  ...
  u_ERROR_WARNING_LIMIT = U_ERROR_WARNING_LIMIT,
  ...
  u_STANDARD_ERROR_LIMIT = U_STANDARD_ERROR_LIMIT,
  u_BAD_VARIABLE_DEFINITION = U_BAD_VARIABLE_DEFINITION,
  u_PARSE_ERROR_START = U_PARSE_ERROR_START,    
  u_MALFORMED_RULE = U_MALFORMED_RULE,
  u_MALFORMED_SET = U_MALFORMED_SET,
  u_MALFORMED_SYMBOL_REFERENCE = U_MALFORMED_SYMBOL_REFERENCE,
  ...
  u_MISMATCHED_SEGMENT_DELIMITERS = U_MISMATCHED_SEGMENT_DELIMITERS,
  u_MISPLACED_ANCHOR_START = U_MISPLACED_ANCHOR_START,
  ...
  u_MISSING_SEGMENT_CLOSE = U_MISSING_SEGMENT_CLOSE,
  ...
  u_INVALID_PROPERTY_PATTERN = U_INVALID_PROPERTY_PATTERN,
  u_MALFORMED_PRAGMA = U_MALFORMED_PRAGMA,
  u_UNCLOSED_SEGMENT = U_UNCLOSED_SEGMENT,
  u_ILLEGAL_CHAR_IN_SEGMENT = U_ILLEGAL_CHAR_IN_SEGMENT,
  ...
  u_PARSE_ERROR_LIMIT = U_PARSE_ERROR_LIMIT,
  u_UNEXPECTED_TOKEN = U_UNEXPECTED_TOKEN,       
  u_FMT_PARSE_ERROR_START = U_FMT_PARSE_ERROR_START,  
  ...
  u_UNSUPPORTED_PROPERTY = U_UNSUPPORTED_PROPERTY,
  u_UNSUPPORTED_ATTRIBUTE = U_UNSUPPORTED_ATTRIBUTE,
  ...
  u_FMT_PARSE_ERROR_LIMIT = U_FMT_PARSE_ERROR_LIMIT,
  u_BRK_INTERNAL_ERROR = U_BRK_INTERNAL_ERROR,          
  u_BRK_ERROR_START = U_BRK_ERROR_START,             
  ...
  u_BRK_ERROR_LIMIT = U_BRK_ERROR_LIMIT,
  u_REGEX_INTERNAL_ERROR = U_REGEX_INTERNAL_ERROR,       
  u_REGEX_ERROR_START = U_REGEX_ERROR_START,          
  ...
  u_REGEX_LOOK_BEHIND_LIMIT = U_REGEX_LOOK_BEHIND_LIMIT,
  ...
  u_REGEX_ERROR_LIMIT = U_REGEX_ERROR_LIMIT,
